...
export function CTA() {
  return (
    <div className='w-full rounded-[16px] bg-gradient-to-br from-rose-400 via-fuchsia-500 to-indigo-500 py-[56px] px-[32px] text-center lg:my-[60px] lg:px-[324px] lg:py-[89px]'>
      ...
      <div className='mt-[40px] flex flex-col w-full items-center lg:mt-[56px] lg:flex-row lg:justify-center gap-x-[40px]'>
        <button className='py-[16px] px-[32px] bg-white rounded-[4px] text-fuchsia-500 font-medium w-fit'>
          Try for Free
        </button>
